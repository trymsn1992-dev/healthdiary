...
export default function LoginPage() {
    ...
    async function signInWithGoogle() {
        ...
        // If successful, it redirects away instantly so we leave loading true
    }
            ...
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-zinc-900/50 p-8 shadow-xl ring-1 ring-white/10 backdrop-blur-xl">
                ...
                <div className="mt-8 space-y-6">
                    ...
                    <p className="text-center text-xs text-zinc-500 mt-6">
                        By logging in, you agree to store your health data securely in the cloud.
                    </p>
                </div>
            </div>
        </div>
