...
export function MoodLoggerV2({ onMoodSelect, selectedMood }: MoodLoggerProps) {
    return (
        <div className="w-full p-4 rounded-xl bg-neutral-900 border border-neutral-800">
            <h2 className="text-lg font-semibold mb-4 text-neutral-200">How do you feel today? (1-10)</h2>
